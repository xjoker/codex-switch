...
| `$CODEX_SWITCH_HOME/provider-runs/<alias>/` | Per-launch isolated Codex homes. Kept outside provider profiles so an active session survives provider rename or removal. |
